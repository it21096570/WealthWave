package com.example.wealthwave.Database
...
class DBHandler(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {
    override fun onCreate(db: SQLiteDatabase) {
        db.execSQL(SQL_CREATE_ENTRIES_INVESMENT)
    ...
    override fun onUpgrade(db: SQLiteDatabase, oldVersion: Int, newVersion: Int) {
        ...
        db.execSQL(SQL_DELETE_ENTRIES_INVESMENT)
        onCreate(db)
    ...
    companion object {
        ...
        const val DATABASE_NAME = "WealthWaweDB.db"
    }


    private val SQL_CREATE_ENTRIES_INVESMENT =
    ...
    private val SQL_DELETE_ENTRIES_INVESMENT = "DROP TABLE IF EXISTS ${Invesment.Users.TABLE_NAME}"
    ...
    fun addInfo(type: String, invesmentName: String, startDate: String, endDate: String, currency: String, invesmentValue: String, incomeValue: String) {
        ...
        val newRowId = db?.insert(Invesment.Users.TABLE_NAME, null, values)
    }
